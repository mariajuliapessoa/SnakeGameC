...
if(jogo->mat[jogo->blocos.rabo->TipoItemGerado.x][jogo->blocos.rabo->TipoItemGerados.y] == ' ' && jogo->blocos.rabo->TipoItemGerado.){  //identificar oq ele faz aq pq o jumento n arrastou a tela pro lado
flag = 1;
...
gotoxy(25, 15);
printf("\a");
printf("Flopou horrores! Tente outra vez!\n");
liberar(jogo);
getch();
system("cls");
}
